...
while True: #looping yang akan terus berjalan selama kondisi didalamnya 'True'
    ...
    if pilihan == '1': #jika pilihan == 1 (Tampilkan Data)
        ...
        update_barang = input("Masukkan Nama data Barang yang akan diperbarui: ")
        new_data = {'Nama_Barang': input("Masukkan nama barang baru: "), 'Harga': input("Masukkan harga: "), 'Jumlah_Stok': input("Masukkan jumlah stok: ")}
